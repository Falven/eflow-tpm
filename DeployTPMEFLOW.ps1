...
dotnet build "tpm-read-nv\tpm-read-nv.csproj" -c "Release" -p:DeployOnBuild=true -p:MyRuntimeIdentifier=linux-x64
dotnet build "tpm-write-nv\tpm-write-nv.csproj" -c "Release" -p:DeployOnBuild=true -p:MyRuntimeIdentifier=win-x64
